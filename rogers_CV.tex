...
\begin{itemize}
\addtolength{\itemindent}{31.7 mm}
\item{\textbf{Java} (advanced), \textbf{Swift} (advanced), \textbf{SQL} (working proficiency), \textbf{Processing} (work-

 \hspace{30.5 mm}  ing proficiency) \textbf{\LaTeX}\ (working proficiency) }
\end{itemize}
