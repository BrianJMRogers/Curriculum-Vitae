...
\begin{itemize}
\addtolength{\itemindent}{31.7 mm}
\item{\textbf{Java} (advanced, two years), \textbf{Swift} (advanced, one year), \textbf{SQL} (working proficiency, 

\hspace{30.5 mm} three months), \textbf{Processing} (working proficiency, six months) \textbf{\LaTeX}\ (working profici-

\hspace{30.5 mm} ency, six months) }
\end{itemize}
...
\end{tabular}
 ...
 \hspace{32 mm}and good music to my listeners}
 \end{itemize}
