...
\end{tabular}
 ...
 \item{Single-handedly developed an original concept }
...
\end{tabular}
 ...
 \item{Responsible for the multicasting/unicasting code that outsourced the jobs and 
 
  \hspace{30.5 mm} aggregated the results}
...
\begin{itemize}
\addtolength{\itemindent}{31.7 mm}
\item{Git, Xcode, Atom, Vim, Linux, MacOS}
...
\end{tabular}
 ...
 \begin{itemize}
 \addtolength{\itemindent}{31.7 mm}
 \item{Cohost weekly music and talkshow with two friends}
 \item{Draft weekly radio-show plans consisting of music and talking points}
 \item{Responsible for curating radio-worthy content}
 \end{itemize}
...
\end{tabular}
 ...
 \item{Applied to and participated in semester-long study abroad program independent of 
  ...
  \item{Developed a working proficiency of Dutch through coursework and immersion}
 \item{Organized a self-guided nine-country study tour}
 \end{itemize}
