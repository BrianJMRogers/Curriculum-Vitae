...
\end{tabular}
 ...
 \addtolength{\itemindent}{31.7 mm}
 \vspace{2 pt}
 \item Tasked to work on multiple company products requiring the use of, and learning of, a 
 
 \hspace{30.5 mm} wide ranging set of technologies 
  
 \item Developed everything from API's to middleware to low-level endpoint data collection 
 
 \hspace{30.5 mm}using object oriented and functional programming languages
 
 \item Utilized industry standard work flows and tools to coordinate with teammates and take
 
 \hspace{30.5 mm} tickets from inception to development, testing, and delivery 
 \end{itemize}
...
\end{tabular}
 ...
 \item Released two apps, \href{https://itunes.apple.com/us/app/fratty-bird-the-game/id1143642394?mt=8}{\textit{Fratty Bird}} and \href{https://itunes.apple.com/us/app/posture-reminder/id1280214465?mt=8}{\textit{Posture Reminder}}, which have 
   ...
   \hspace{30.5 mm}  accumulated over 15,000 downloads
...
\begin{itemize}
\addtolength{\itemindent}{31.7 mm}
\item{C/C++, Clojure, C\#, Java, Bash, Swift, \LaTeX}
\end{itemize}
