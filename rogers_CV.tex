...
\end{tabular}
 \hspace{2 mm}
 \textbf{Software Engineer @ \href{https://www.root9b.com/}{root9B}} (\textit{ranked by Cybersecurity Ventures as the \href{https://www.prnewswire.com/news-releases/root9b-remains-1-on-cybersecurity-500-for-6th-consecutive-quarter-300478860.html}{\underline{\#1}}}
...
\hspace{30 mm} \href{https://www.prnewswire.com/news-releases/root9b-remains-1-on-cybersecurity-500-for-6th-consecutive-quarter-300478860.html}{\textit{\underline{cybersecurity company in the world} for 6 straight quarters}})
 ...
 \addtolength{\itemindent}{31.7 mm}
 \vspace{2 pt}
 \item Work directly on \textit{root9B}'s flagship product \textit{Orion}
 
 \item Deliver quality code and tests in an agile environment
 
\item Maintain a production-level Git workflow
 
 \item Utilize industry standard software development tools (\textit{Atlassian} products like \textit{Jira} etc.,
 
 \hspace{30.5 mm} \textit{git},  agile development cycles)
...
\end{tabular}
 ...
 \item Released two apps, \href{https://itunes.apple.com/us/app/fratty-bird-the-game/id1143642394?mt=8}{\textit{Fratty Bird}} and \href{https://itunes.apple.com/us/app/posture-reminder/id1280214465?mt=8}{\textit{Posture Reminder}}, which have 
   ...
   \hspace{30.5 mm}  accumulated over 9,000 downloads
